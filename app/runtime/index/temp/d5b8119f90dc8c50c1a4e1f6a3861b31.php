<?php /*a:3:{s:53:"/home/wwwroot/www.fsqf.com/view/index/page/index.html";i:1691502949;s:54:"/home/wwwroot/www.fsqf.com/view/index/conn/header.html";i:1691503821;s:54:"/home/wwwroot/www.fsqf.com/view/index/conn/footer.html";i:1692863141;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<meta name="keywords" content="<?php echo htmlentities($model['name']); ?>" />
                      ...
                      <div class="technical_support_box">
                        ...
                        <ul>
                         <?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): if( count($category)==0 ) : echo "" ;else: foreach($category as $k=>$v): ?>
                          <li> <a href="/page/<?php echo htmlentities($v['id']); ?>.html">
                            <div class="text"><?php echo htmlentities($v['name']); ?> </div>
