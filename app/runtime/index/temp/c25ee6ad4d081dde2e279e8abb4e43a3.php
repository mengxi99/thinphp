<?php /*a:1:{s:82:"C:\Users\xgf15\Desktop\study\first\www.fsqf.com_GsGcWs\view\index\index\index.html";i:1717056968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!--                <li>2024-05-09</li>-->
        ...
        <div class="swiper" style="margin-left: -500px">
            <ul class="swiper-wrapper" style="display: flex;justify-content: space-between; ;list-style-type: none;margin-right: 1000px">
...
<!--                    <div class="swiper-slide">-->
                        <li  class="swiper-slide" style="display: inline;width: 350px;height: 440px;margin-right: 10px">
