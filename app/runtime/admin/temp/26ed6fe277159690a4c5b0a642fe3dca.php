<?php /*a:1:{s:85:"C:\Users\xgf15\Desktop\study\first\www.fsqf.com_GsGcWs\view\admin\ad\index\index.html";i:1691821057;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-row layui-col-space10">
  		...
  		<div class="layui-card">
			...
			<div class="layui-card-body">
			    <ul>
			        ...
			        <li style="line-height:40px;" data-id="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['name']); ?></li>
  ...
  <div class="layui-col-md11">
        ...
        layui.use(['table', 'form', 'jquery','common','laydate'], function() {
            ...
            let MODULE_PATH = "<?php echo htmlentities(app('request')->root()); ?>/ad.index/";
