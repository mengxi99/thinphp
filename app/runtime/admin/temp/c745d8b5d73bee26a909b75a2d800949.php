<?php /*a:1:{s:91:"C:\Users\xgf15\Desktop\study\first\www.fsqf.com_GsGcWs\view\admin\category\index\index.html";i:1691716154;}*/ ?>
    ...
    <script src="/static/component/pear/pear.js"></script>
        <script>
            layui.use(['table','form','treetable', 'jquery'],function () {
                ...
                let MODULE_PATH = "<?php echo htmlentities(app('request')->root()); ?>/category.index/";
                    ...
                    treetable.render({
                        ...
                        cols: [
                            ...
                            {field: 'title', minWidth: 200, unresize: true,title: '名称'},  
                             {field: 'id', minWidth: 200, unresize: true,title: 'ID'},  
                            {title: '状态', field: 'status',align: 'center',unresize: true,templet: '#status'},
                            {title: '模型', field: 'model',align: 'center',unresize: true,templet: '#model'},
