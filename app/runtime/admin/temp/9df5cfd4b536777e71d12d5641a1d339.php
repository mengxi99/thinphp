<?php /*a:1:{s:87:"C:\Users\xgf15\Desktop\study\first\www.fsqf.com_GsGcWs\view\admin\page\index\index.html";i:1691634205;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script type="text/html" id="options">
      <button class="pear-btn pear-btn-primary pear-btn-sm" lay-event="edit"><i class="layui-icon layui-icon-edit"></i></button>
        ...
        layui.use(['table', 'form', 'jquery','common','laydate'], function() {
            ...
            let MODULE_PATH = "<?php echo htmlentities(app('request')->root()); ?>/page.index/";
