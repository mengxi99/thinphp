<?php /*a:3:{s:53:"/home/wwwroot/www.fsqf.com/view/index/lists/show.html";i:1691502926;s:54:"/home/wwwroot/www.fsqf.com/view/index/conn/header.html";i:1691503821;s:54:"/home/wwwroot/www.fsqf.com/view/index/conn/footer.html";i:1692863141;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<title><?php echo htmlentities($model['name']); ?>-<?php echo cfg('shorttitle'); ?></title>
<meta name="keywords" content="<?php echo htmlentities($model['key']); ?>" />
<meta name="description" content="<?php echo htmlentities($model['describe']); ?>" />
                    ...
                    <div class="technical_support_list">
                      <div class="technical_support_box_z">
                        <div class="technical_support_box_z_header">
                          <div class="title" ><?php echo htmlentities($model['name']); ?></div>
                         
                        </div>
                        <div class="technical_support_box_z_info_box" >     <?php echo $model['content']; ?> <div>
	
	       </div>
                          <div class="technical_support_box_z_info_box_shangxia">
                            <?php if(($front)): ?> <li>上一篇：<a href="/show/<?php echo htmlentities($front['id']); ?>.html"><?php echo htmlentities($front['name']); ?></a></li><?php endif; if(($after)): ?> <li>下一篇：<a href="/show/<?php echo htmlentities($after['id']); ?>.html"><?php echo htmlentities($after['name']); ?></a> </li> <?php endif; ?>
                          </div>
                        </div>
                      </div>
                    </div>
