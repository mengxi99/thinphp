<?php /*a:1:{s:80:"C:\Users\xgf15\Desktop\study\first\www.fsqf.com_GsGcWs\view/tpl/success_tmpl.tpl";i:1633663235;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
    	...
    	<div class="layui-card">
			<div class="layui-card-body">
				<div class="result">
					...
					<h2 class="title"><?php echo htmlentities($msg); ?></h2>
					<p class="desc">
						 <?php echo htmlentities($data); ?>
					</p>
					<div class="action">
                     <a id="href" href="<?php echo htmlentities($url); ?>" class="pear-btn pear-btn-primary">立即跳转</a>
